...
module InheritedViews
  class Base < ::InheritedResources::Base
	...
	success.js { render_or_default 'create_success'}
	failure.js { render_or_default 'create_failure'}
	...
	success.js { render_or_default 'update_success'}
	failure.js { render_or_default 'update_failure'}
      end
    end
